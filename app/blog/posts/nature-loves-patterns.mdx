...
summary: 'Patterns are everywhere, and our brains are wired to find them.'
minuteRead: 5
image: '/assets/blog/nature-loves-patterns/cover.png'
...
Watching him, I'm reminded that when we're very young, we don't yet have a fully built network in our brains that would help us visually understand what is "hot" and what is "cold". When he reaches out and touches the stove, what some might call a _wood-burning stove_ - he feels the burn instantly. It's not that he's thinking, "I shouldn't touch that because it's hot"; he's simply experiencing something new.
...
In fact we humans may even go to the extent of finding patterns where there are none - a phenomenon called [_Apophenia_](https://en.wikipedia.org/wiki/Apophenia). This is why we see faces in clouds, hear messages in songs played backwards, and find meaning in random events. Our brains are wired to find patterns, even when they don't exist.
Here is Neil deGrasse Tyson debunking the mysterious square structure on Mars in a [video](https://youtu.be/dYDa9cZptTY?si=7CcnwuaITpmrenHz).
